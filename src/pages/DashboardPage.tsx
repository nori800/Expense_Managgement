...
import { useAuthStore, dummyExpenses } from '../store/authStore';
...
export function DashboardPage() {
  ...
  const approvedCount = dummyExpenses.filter(e => e.status === 'approved').length;
  const rejectedCount = dummyExpenses.filter(e => e.status === 'rejected').length;
